...
const nowm = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://www.arugaz.my.id/api/media/tiktok?url=${url}`)
    .then(res => {
        resolve(res.data)
      })
      .catch(err => {
...
const twit = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://www.arugaz.my.id/api/media/twvid?url=${url}`)
    .then(res => {
        resolve(res.data)
    })
    .catch(err => {
...
const fb2 = async (url) => new Promise((resolve,reject) => {
    axios.get(`https://www.arugaz.my.id/api/media/facebook?url=${url}`)
    .then(res => {
        resolve(res.data)
    })
    .catch(err => {
...
const ytmp3 = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://www.arugaz.my.id/api/media/ytmus?url=${url}`)
    .then((res) => {
		resolve(res.data)
    })
    .catch((err) =>{
...
const ymp4 = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://www.arugaz.my.id/api/media/ytvid?url=${url}`)
    .then((res) => {
		resolve(res.data)
    })
    .catch((err) =>{
...
const stalktwit = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://www.arugaz.my.id/api/media/stalktwitt?user=${url}`)
    .then((res) => {
        if (res.data.error) resolve(res.data.error)
